...
#define HIGH_LIM1 	0x9200 	// base about +90 degrees right/left?
#define LOW_LIM1 	0x6800	// base about -90 degrees
//#define HIGH_LIM2 	0x8a00	// temp
//#define HIGH_LIM2 	0x8600	// Shoulder about 45 degrees  forward
//#define LOW_LIM2 	0x7400	// Shoulder about -45 degrees backward
#define HIGH_LIM2 	0xffff	
#define LOW_LIM2 	0x0000	
...
//			printf("sum: %x\n",sum);
			if((sum > HIGH_LIM1)  || (sum < LOW_LIM1)){
				mvprintw(17,0,"Joint 1 exceeds limits\n\n");
				refresh();
				return -1;
			}
		...
		case 0x21:
			...
			if((sum > HIGH_LIM2)  || (sum < LOW_LIM2)){
				mvprintw(17,0,"Joint 2 exceeds limits\n\n");
				refresh();
			//	printf("sum: %x\n",sum);
				return -1;
			}
		...
		case 0x31:
			...
			if((sum > HIGH_LIM3)  || (sum < LOW_LIM3)){
				mvprintw(17,0,"Joint 3 exceeds limits\n\n");
				refresh();
		...
		case 0x41:
			...
			if((sum > HIGH_LIM4)  || (sum < LOW_LIM4)){
				mvprintw(17,0,"Joint 4 exceeds limits\n\n");
				refresh();
				return -1;
			}
			sprintf(buff,"%03x#%02x.%02x.%02x.%02x.%02x.%02x.%02x\0",id,data1,data2,data3,data4,data5,data6);
